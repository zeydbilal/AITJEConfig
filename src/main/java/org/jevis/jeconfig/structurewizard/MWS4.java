...
public class MWS4 extends WizardPane {
    ...
    public MWS4(ObjectTree tree, WizardSelectedObject wizardSelectedObject) {
    ...
    public void commitObject() {
        try {
            ...
            Logger.getLogger(MWS4.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
