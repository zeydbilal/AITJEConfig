...
public class MWS5 extends WizardPane {
    ...
    public MWS5(ObjectTree tree, WizardSelectedObject wizardSelectedObject) {
    ...
    public void commitObject() {
        try {
            ...
            Logger.getLogger(MWS5.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
