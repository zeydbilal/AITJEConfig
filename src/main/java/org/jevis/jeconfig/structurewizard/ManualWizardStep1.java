...
public class ManualWizardStep1 extends WizardPane {
    ...
    public void commitObject() {
        ...
        try {
            ...
            //Speichere das neue erzeugte Building-Objekt als CurrentSelectedBuildingObject ab.
            ...
            if (allowedChildrenClasses.size() > 0) {
                for (int i = 0; i < allowedChildrenClasses.size(); i++) {
                    ...
                    if (allowedChildrenClasses.get(i).getName().equals("Data Directory")) {
                        ...
                        //Speichere Data Directory Objekt in die Liste ab.
            ...
            //We need Data Source Directory for the second step
            ...
            for (int i = 0; i < listChildren.size(); i++) {
                if (listChildren.get(i).getName().equals("Data Source Directory")) {
                    ...
                    //Speichere Data Source Directory Objekt in die Liste ab.
                    wizardSelectedObject.setCurrentTemplateObjects(listChildren.get(i));
                }
            }
